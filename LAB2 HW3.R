...
#Group Members: Arifa Begum, Maria Camila, Leo Alcaide, Sun Wo Kim
...
#GRAPH 1. MENTAL HELATH AND VAXX
...
#By examining the different facets (plots for each education level), we can see 
#how the distribution of vaccination status varies with education level. 
#We observe that individuals with some college diplomas, associate degrees, 
#and bachelor’s degrees have higher densities for the vaccination status labeled as "Yes, got vaccine."
...
## Through my lab, I concluded that there is a notable trend correlated between
#income levels and whether people are vaccinated or not. It seems that across all 
#income levels, at least 75%  of every level is vaccinated. The higher income levels 
#seem to have larger percentages of people being vaccinated. 
#However, I do not think this directly means that income plays a role in whether
#someone is vaccinated or not. I think the trend is like this because the population
#for higher incomes is less, therefore, even if there is a little more people vaccinated, 
#it shows up as a bigger portion of the population being vaccinated (almost 90%).
# This data only asks the birth gender of the recipents. They were also asked about 
#their gender description however too many people answered NA so 
#it is very difficult to analysis that data set. For the people who did get vaccined,
#a little over half of them(over 25000), were male and those who did not get vaccined, 
#a little over half (over 5000) were female.As for the NA, it is looks to have
#slight majority of women. This means that men were overall men were more likely to get the vaccine.





#Graph 5: GENDER AND VAXX 
load("~/Desktop/Household_Pulse_data_ph4c2.RData")
library(tidyverse)
library(ggplot2)
library(ggthemes)
...
# This data only asks the birth gender of the recipents. They were also asked about 
#their gender description however too many people answered NA so it is very
#difficult to analysis that data set. For the people who did get vaccined,
#a little over half of them(over 25000), were male and those who did not get vaccined, 
#a little over half (over 5000) were female.As for the NA, it is looks to have slight
#majority of women.This means that men were overall men were more likely to get the vaccine.
